...
def solve(data):
    ...
    return min([a_star_search(direction_map, node_map, goal, start) for start in starts])

table = None
node_map = None

def a_star_search(direction_map, node_map, goal, start):
    global table
